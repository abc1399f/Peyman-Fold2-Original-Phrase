...
#        os.chdir(os.getenv('/content/HOME/ner_bert_crf'))
#    elif (os.path.exists('/content/HOME/ner_bert_crf')):
#        os.chdir('/content/HOME/ner_bert_crf')
#        raise Exception('Set work path error!')


#def get_data_dir(local_path="ner_bert_crf", server_path="ner_bert_crf"):
#    if (os.path.exists(os.getenv(str("content/HOME/ner_bert_crf")))):
#        return os.getenv (str("content/HOME/ner_bert_crf"))
#    elif (os.path.exists(os.getenv(str("content/HOME/ner_bert_crf")))):
#        return os.getenv(str("content/HOME/ner_bert_crf"))
#    else:
...
data_dir = os.path.join( '/content/Peyman-Fold2-Original-Phrase/data/Fold2/')
...
output_dir = '/content/Peyman-Fold2-Original-Phrase/output/'
...
#dev_dataloader = data.DataLoader(dataset=dev_dataset, batch_size=batch_size,  shuffle=False, num_workers=4, collate_fn=NerDataset.pad)
